...
namespace Blog.Controllers
{
    public class BlogPostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PostId,Creator,Title,Body,Dt")] BlogPost blogPost)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PostId,Creator,Title,Body,Dt")] BlogPost blogPost)
        {
